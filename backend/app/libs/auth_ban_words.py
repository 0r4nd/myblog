...
# from: https://gist.github.com/DavidWells/480876a2fa9226f5170e486ae31e3d94
FORBIDDEN_USERNAMES = [
    # Meteor app routes
    'page-not-found', 'docs', 'terms-of-use', 'about', 'pricing',
    'privacy-policy', 'customers', 'request-form', 'request-solution',
    'release-notes', 'jobs', 'api-reference', 'video-tutorials', 'acts',
    'key-value-stores', 'schedules', 'account', 'sign-up', 'sign-in-discourse', 'admin',
...
BAN_WORDS_REGEXP = re.compile(fr'^({"|".join(FORBIDDEN_USERNAMES)}|{"|".join(BANNED_USERNAMES)})$')

def is_forbidden_username(username):
  return BAN_WORDS_REGEXP.match(username) != None
